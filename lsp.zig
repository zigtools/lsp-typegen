...
pub const WorkspaceEdit = struct {
    ...
    changes: Undefinedable(std.StringArrayHashMap([]TextEdit)),
    ...
    changeAnnotations: Undefinedable(std.StringArrayHashMap(ChangeAnnotation)),
};
...
pub const DocumentSymbol = struct {
    ...
    children: []DocumentSymbol = &[0]DocumentSymbol{},
};
...
pub const TextDocumentClientCapabilities = struct {
    ...
    moniker: Undefinedable(MonikerClientCapabilities),
};
...
pub const ClientCapabilities = struct {
    ...
    experimental: Undefinedable(std.json.ObjectMap),
...
pub const ServerCapabilities = struct {
    ...
    experimental: Undefinedable(std.json.Value),
...
pub const RenameClientCapabilities = struct {
    ...
    prepareSupportDefaultBehavior: i64 = 1,
