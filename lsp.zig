...
const CodeActionTriggerKind = enum(i64) {
    Automatic = 2,
    Invoked = 1,
...
const InlineValuesClientCapabilities = struct {
    /// Whether implementation supports dynamic registration for inline value providers.
    dynamicRegistration: bool,
};

/// Inline values options used during static registration.
const InlineValuesOptions = struct {
    workDoneProgress: bool,
};

/// Inline value options used during static or dynamic registration.
const InlineValuesRegistrationOptions = struct {
...
const InlineValuesWorkspaceClientCapabilities = struct {
...
const TypeHierarchyOptions = struct {
    workDoneProgress: bool,
};

/// Type hierarchy options used during static or dynamic registration.
const TypeHierarchyRegistrationOptions = struct {
    /// A document selector to identify the scope of the registration. If set to null
    /// the document selector provided on the client side will be used.
    documentSelector: ?DocumentSelector,
...
/// symbol's location.
const WorkspaceSymbolResolveRequest = struct {
...
const ServerCapabilities = struct {
    ...
    inlineValuesProvider: union(enum) {
        boolean: bool,
