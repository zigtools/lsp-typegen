...
/// inside a text file.
pub const Location = struct {uri: []const u8,
range: Range,
};
...
pub const FoldingRangeKind = struct {pub const Comment = "comment";pub const Imports = "imports";pub const Region = "region";};
...
pub const DiagnosticSeverity = enum(i64) {Error = 1,Warning = 2,Information = 3,Hint = 4,
...
/// The diagnostic tags.
pub const DiagnosticTag = enum(i64) {Unnecessary = 1,Deprecated = 2,
...
code: Undefinedable(union(enum) {string: []const u8,
number: i64,
}),
...
documentChanges: Undefinedable([]union(enum) {TextDocumentEdit: TextDocumentEdit,
...
pub const MarkupKind = enum {plaintext,
markdown,
...
pub const CompletionItemKind = enum(i64) {Text = 1,Method = 2,Function = 3,Constructor = 4,Field = 5,Variable = 6,Class = 7,Interface = 8,Module = 9,Property = 10,Unit = 11,Value = 12,Enum = 13,Keyword = 14,Snippet = 15,Color = 16,File = 17,Reference = 18,Folder = 19,EnumMember = 20,Constant = 21,Struct = 22,Event = 23,Operator = 24,TypeParameter = 25,
...
pub const InsertTextFormat = enum(i64) {PlainText = 1,Snippet = 2,
...
/// item.
pub const CompletionItemTag = enum(i64) {Deprecated = 1,
...
/// item insertion.
pub const InsertTextMode = enum(i64) {asIs = 1,adjustIndentation = 2,
...
documentation: Undefinedable(union(enum) {string: []const u8,
...
textEdit: Undefinedable(union(enum) {TextEdit: TextEdit,
...
pub const MarkedString = union(enum) {string: []const u8,
reflection: struct {language: []const u8,
value: []const u8,
},
};
...
/// defined.
pub const Definition = union(enum) {Location: Location,
array: []Location,
};
...
pub const Declaration = union(enum) {Location: Location,
array: []Location,
};
...
pub const DocumentHighlightKind = enum(i64) {Text = 1,Read = 2,Write = 3,
...
/// A symbol kind.
pub const SymbolKind = enum(i64) {File = 1,Module = 2,Namespace = 3,Package = 4,Class = 5,Method = 6,Property = 7,Field = 8,Constructor = 9,Enum = 10,Interface = 11,Function = 12,Variable = 13,Constant = 14,String = 15,Number = 16,Boolean = 17,Array = 18,Object = 19,Key = 20,Null = 21,EnumMember = 22,Struct = 23,Event = 24,Operator = 25,TypeParameter = 26,
...
pub const SymbolTag = enum(i64) {Deprecated = 1,
...
workspace: Undefinedable(struct {workspaceFolders: Undefinedable(struct {
/// Whether the server wants to receive workspace folder
/// change notifications.
changeNotifications: Undefinedable(union(enum) {string: []const u8,
boolean: bool,
}),
...
pub const ProgressToken = union(enum) {number: i64,
string: []const u8,
};
...
pub const DocumentFilter = union(enum) {reflection: struct {
...
pub const DocumentSelector = []union(enum) {string: []const u8,
...
pub const RegistrationParams = struct {registrations: []Registration,
};

/// The `client/registerCapability` request is sent from the server to the client to register a new capability
/// handler on the client side.
pub const RegistrationRequest = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const UnregistrationParams = struct {unregisterations: []Unregistration,
};

/// The `client/unregisterCapability` request is sent from the server to the client to unregister a previously registered capability
/// handler on the client side.
pub const UnregistrationRequest = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const WorkDoneProgressOptions = struct {workDoneProgress: Undefinedable(bool),
};
pub const ServerCapabilities = struct {
/// Defines how text documents are synced. Is either a detailed structure defining each notification or
/// for backwards compatibility the TextDocumentSyncKind number.
textDocumentSync: Undefinedable(union(enum) {TextDocumentSyncOptions: TextDocumentSyncOptions,
...
hoverProvider: Undefinedable(union(enum) {boolean: bool,
...
declarationProvider: Undefinedable(union(enum) {boolean: bool,
DeclarationOptions: DeclarationOptions,
DeclarationRegistrationOptions: DeclarationRegistrationOptions,
}),

/// The server provides goto definition support.
definitionProvider: Undefinedable(union(enum) {boolean: bool,
DefinitionOptions: DefinitionOptions,
}),

/// The server provides Goto Type Definition support.
typeDefinitionProvider: Undefinedable(union(enum) {boolean: bool,
TypeDefinitionOptions: TypeDefinitionOptions,
TypeDefinitionRegistrationOptions: TypeDefinitionRegistrationOptions,
}),

/// The server provides Goto Implementation support.
implementationProvider: Undefinedable(union(enum) {boolean: bool,
ImplementationOptions: ImplementationOptions,
ImplementationRegistrationOptions: ImplementationRegistrationOptions,
}),

/// The server provides find references support.
referencesProvider: Undefinedable(union(enum) {boolean: bool,
ReferenceOptions: ReferenceOptions,
}),

/// The server provides document highlight support.
documentHighlightProvider: Undefinedable(union(enum) {boolean: bool,
DocumentHighlightOptions: DocumentHighlightOptions,
}),

/// The server provides document symbol support.
documentSymbolProvider: Undefinedable(union(enum) {boolean: bool,
...
codeActionProvider: Undefinedable(union(enum) {boolean: bool,
...
colorProvider: Undefinedable(union(enum) {boolean: bool,
DocumentColorOptions: DocumentColorOptions,
DocumentColorRegistrationOptions: DocumentColorRegistrationOptions,
}),

/// The server provides workspace symbol support.
workspaceSymbolProvider: Undefinedable(union(enum) {boolean: bool,
WorkspaceSymbolOptions: WorkspaceSymbolOptions,
}),

/// The server provides document formatting.
documentFormattingProvider: Undefinedable(union(enum) {boolean: bool,
DocumentFormattingOptions: DocumentFormattingOptions,
}),

/// The server provides document range formatting.
documentRangeFormattingProvider: Undefinedable(union(enum) {boolean: bool,
...
renameProvider: Undefinedable(union(enum) {boolean: bool,
RenameOptions: RenameOptions,
}),

/// The server provides folding provider support.
foldingRangeProvider: Undefinedable(union(enum) {boolean: bool,
FoldingRangeOptions: FoldingRangeOptions,
FoldingRangeRegistrationOptions: FoldingRangeRegistrationOptions,
}),

/// The server provides selection range support.
selectionRangeProvider: Undefinedable(union(enum) {boolean: bool,
...
callHierarchyProvider: Undefinedable(union(enum) {boolean: bool,
CallHierarchyOptions: CallHierarchyOptions,
CallHierarchyRegistrationOptions: CallHierarchyRegistrationOptions,
}),

/// The server provides linked editing range support.
linkedEditingRangeProvider: Undefinedable(union(enum) {boolean: bool,
...
semanticTokensProvider: Undefinedable(union(enum) {SemanticTokensOptions: SemanticTokensOptions,
...
monikerProvider: Undefinedable(union(enum) {boolean: bool,
...
/// resolves to such.
pub const InitializeRequest = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const InitializeError = enum(i64) {unknownProtocolVersion = 1,
...
pub const InitializedNotification = struct {pub const @"type" = ManuallyTranslateValue;};

/// A shutdown request is sent from the client to the server.
/// It is sent once when the client decides to shutdown the
/// server. The only notification that is sent after a shutdown request
/// is the exit event.
pub const ShutdownRequest = struct {pub const @"type" = ManuallyTranslateValue;};

/// The exit event is sent from the client to the server to
/// ask the server to exit its process.
pub const ExitNotification = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const DidChangeConfigurationNotification = struct {pub const @"type" = ManuallyTranslateValue;};
pub const DidChangeConfigurationRegistrationOptions = struct {section: Undefinedable(union(enum) {string: []const u8,
array: [][]const u8,
}),
};
...
/// The message type
pub const MessageType = enum(i64) {Error = 1,Warning = 2,Info = 3,Log = 4,
...
pub const ShowMessageNotification = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const ShowMessageRequest = struct {pub const @"type" = ManuallyTranslateValue;};

/// The log message notification is sent from the server to the client to ask
/// the client to log a particular message.
pub const LogMessageNotification = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const TelemetryEventNotification = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const TextDocumentSyncKind = enum(i64) {None = 0,Full = 1,Incremental = 2,
...
/// sent.
save: Undefinedable(union(enum) {boolean: bool,
...
/// is one.
pub const DidOpenTextDocumentNotification = struct {pub const method = "textDocument/didOpen";pub const @"type" = ManuallyTranslateValue;};

/// An event describing a change to a text document. If range and rangeLength are omitted
/// the new text is considered to be the full content of the document.
pub const TextDocumentContentChangeEvent = union(enum) {reflection: struct {
...
pub const DidChangeTextDocumentNotification = struct {pub const method = "textDocument/didChange";pub const @"type" = ManuallyTranslateValue;};
...
pub const DidCloseTextDocumentNotification = struct {pub const method = "textDocument/didClose";pub const @"type" = ManuallyTranslateValue;};
...
pub const DidSaveTextDocumentNotification = struct {pub const method = "textDocument/didSave";pub const @"type" = ManuallyTranslateValue;};

/// Represents reasons why a text document is saved.
pub const TextDocumentSaveReason = enum(i64) {Manual = 1,AfterDelay = 2,FocusOut = 3,
...
pub const WillSaveTextDocumentNotification = struct {pub const method = "textDocument/willSave";pub const @"type" = ManuallyTranslateValue;};
...
/// reliable.
pub const WillSaveTextDocumentWaitUntilRequest = struct {pub const method = "textDocument/willSaveWaitUntil";pub const @"type" = ManuallyTranslateValue;};
...
pub const DidChangeWatchedFilesNotification = struct {pub const @"type" = ManuallyTranslateValue;};
...
/// The file event type
pub const FileChangeType = enum(i64) {Created = 1,Changed = 2,Deleted = 3,
...
pub const WatchKind = enum(i64) {Create = 1,Change = 2,Delete = 4,
...
pub const PublishDiagnosticsNotification = struct {pub const @"type" = ManuallyTranslateValue;};
...
insertTextModeSupport: Undefinedable(struct {valueSet: []InsertTextMode,
}),
...
pub const CompletionTriggerKind = enum(i64) {Invoked = 1,TriggerCharacter = 2,TriggerForIncompleteCompletions = 3,
...
pub const CompletionRequest = struct {pub const method = "textDocument/completion";pub const @"type" = ManuallyTranslateValue;};

/// Request to resolve additional information for a given completion item.The request's
/// parameter is of type [CompletionItem](#CompletionItem) the response
/// is of type [CompletionItem](#CompletionItem) or a Thenable that resolves to such.
pub const CompletionResolveRequest = struct {pub const method = "completionItem/resolve";pub const @"type" = ManuallyTranslateValue;};
...
/// Hover options.
pub const HoverOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const HoverRequest = struct {pub const method = "textDocument/hover";pub const @"type" = ManuallyTranslateValue;};
...
pub const SignatureHelpTriggerKind = enum(i64) {Invoked = 1,TriggerCharacter = 2,ContentChange = 3,
...
pub const SignatureHelpRequest = struct {pub const method = "textDocument/signatureHelp";pub const @"type" = ManuallyTranslateValue;};
...
pub const DefinitionOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
/// to such.
pub const DefinitionRequest = struct {pub const method = "textDocument/definition";pub const @"type" = ManuallyTranslateValue;};
...
pub const ReferenceParams = struct {context: ReferenceContext,
...
/// Reference options.
pub const ReferenceOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const ReferencesRequest = struct {pub const method = "textDocument/references";pub const @"type" = ManuallyTranslateValue;};
...
pub const DocumentHighlightOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const DocumentHighlightRequest = struct {pub const method = "textDocument/documentHighlight";pub const @"type" = ManuallyTranslateValue;};
...
pub const DocumentSymbolRequest = struct {pub const method = "textDocument/documentSymbol";pub const @"type" = ManuallyTranslateValue;};
...
pub const CodeActionRequest = struct {pub const method = "textDocument/codeAction";pub const @"type" = ManuallyTranslateValue;};

/// Request to resolve additional information for a given code action.The request's
/// parameter is of type [CodeAction](#CodeAction) the response
/// is of type [CodeAction](#CodeAction) or a Thenable that resolves to such.
pub const CodeActionResolveRequest = struct {pub const method = "codeAction/resolve";pub const @"type" = ManuallyTranslateValue;};
...
pub const WorkspaceSymbolOptions = struct {workDoneProgress: Undefinedable(bool),
};

/// Registration options for a [WorkspaceSymbolRequest](#WorkspaceSymbolRequest).
pub const WorkspaceSymbolRegistrationOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
/// resolves to such.
pub const WorkspaceSymbolRequest = struct {pub const method = "workspace/symbol";pub const @"type" = ManuallyTranslateValue;};
...
pub const CodeLensRequest = struct {pub const method = "textDocument/codeLens";pub const @"type" = ManuallyTranslateValue;};

/// A request to resolve a command for a given code lens.
pub const CodeLensResolveRequest = struct {pub const method = "codeLens/resolve";pub const @"type" = ManuallyTranslateValue;};

/// A request to refresh all code actions
pub const CodeLensRefreshRequest = struct {pub const method = ManuallyTranslateValue;pub const @"type" = ManuallyTranslateValue;};
...
pub const DocumentLinkRequest = struct {pub const method = "textDocument/documentLink";pub const @"type" = ManuallyTranslateValue;};

/// Request to resolve additional information for a given document link. The request's
/// parameter is of type [DocumentLink](#DocumentLink) the response
/// is of type [DocumentLink](#DocumentLink) or a Thenable that resolves to such.
pub const DocumentLinkResolveRequest = struct {pub const method = "documentLink/resolve";pub const @"type" = ManuallyTranslateValue;};
...
pub const DocumentFormattingOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const DocumentFormattingRequest = struct {pub const method = "textDocument/formatting";pub const @"type" = ManuallyTranslateValue;};
...
pub const DocumentRangeFormattingOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const DocumentRangeFormattingRequest = struct {pub const method = "textDocument/rangeFormatting";pub const @"type" = ManuallyTranslateValue;};
...
pub const DocumentOnTypeFormattingRequest = struct {pub const method = "textDocument/onTypeFormatting";pub const @"type" = ManuallyTranslateValue;};
pub const PrepareSupportDefaultBehavior = enum(i64) {Identifier = 1,
...
pub const RenameRequest = struct {pub const method = "textDocument/rename";pub const @"type" = ManuallyTranslateValue;};
...
pub const PrepareRenameRequest = struct {pub const method = "textDocument/prepareRename";pub const @"type" = ManuallyTranslateValue;};
...
pub const ExecuteCommandRequest = struct {pub const @"type" = ManuallyTranslateValue;};
...
pub const ApplyWorkspaceEditRequest = struct {pub const @"type" = ManuallyTranslateValue;};

/// A request to resolve the implementation locations of a symbol at a given text
/// document position. The request's parameter is of type [TextDocumentPositioParams]
/// (#TextDocumentPositionParams) the response is of type [Definition](#Definition) or a
/// Thenable that resolves to such.
pub const ImplementationRequest = struct {pub const method = "textDocument/implementation";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const ImplementationOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
/// (#TextDocumentPositionParams) the response is of type [Definition](#Definition) or a
/// Thenable that resolves to such.
pub const TypeDefinitionRequest = struct {pub const method = "textDocument/typeDefinition";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const TypeDefinitionOptions = struct {workDoneProgress: Undefinedable(bool),
};

/// The `workspace/workspaceFolders` is sent from the server to the client to fetch the open workspace folders.
pub const WorkspaceFoldersRequest = struct {pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler0;
};

/// The `workspace/didChangeWorkspaceFolders` notification is sent from the client to the server when the workspace
/// folder configuration changes.
pub const DidChangeWorkspaceFoldersNotification = struct {pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = NotificationHandler;
};
...
pub const ConfigurationRequest = struct {pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};

/// The parameters of a configuration request.
pub const ConfigurationParams = struct {items: []ConfigurationItem,
};
...
/// that resolves to such.
pub const DocumentColorRequest = struct {pub const method = "textDocument/documentColor";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
/// response is of type [ColorInformation[]](#ColorInformation) or a Thenable
/// that resolves to such.
pub const ColorPresentationRequest = struct {pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
pub const DocumentColorOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const FoldingRangeOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
/// that resolves to such.
pub const FoldingRangeRequest = struct {pub const method = "textDocument/foldingRange";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
/// to such.
pub const DeclarationRequest = struct {pub const method = "textDocument/declaration";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const DeclarationRegistrationOptions = struct {workDoneProgress: Undefinedable(bool),
...
pub const DeclarationOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const SelectionRangeOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
/// that resolves to such.
pub const SelectionRangeRequest = struct {pub const method = "textDocument/selectionRange";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
pub const SelectionRangeRegistrationOptions = struct {workDoneProgress: Undefinedable(bool),
...
pub const WorkDoneProgressBegin = struct {comptime kind: []const u8 = "begin",
...
pub const WorkDoneProgressReport = struct {comptime kind: []const u8 = "report",
...
pub const WorkDoneProgressEnd = struct {comptime kind: []const u8 = "end",
...
pub const WorkDoneProgressCreateRequest = struct {pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const WorkDoneProgressCancelNotification = struct {pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = NotificationHandler;
};
...
pub const CallHierarchyOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const CallHierarchyIncomingCallsParams = struct {item: CallHierarchyItem,
...
pub const CallHierarchyIncomingCallsRequest = struct {pub const method = "callHierarchy/incomingCalls";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};

/// The parameter of a `callHierarchy/outgoingCalls` request.
pub const CallHierarchyOutgoingCallsParams = struct {item: CallHierarchyItem,
...
pub const CallHierarchyOutgoingCallsRequest = struct {pub const method = "callHierarchy/outgoingCalls";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const CallHierarchyPrepareRequest = struct {pub const method = "textDocument/prepareCallHierarchy";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};

/// A set of predefined token types. This set is not fixed
/// an clients can specify additional token types via the
/// corresponding client capabilities.
pub const SemanticTokenTypes = struct {pub const class = "class";pub const comment = "comment";pub const @"enum" = "enum";pub const enumMember = "enumMember";pub const event = "event";pub const function = "function";pub const interface = "interface";pub const keyword = "keyword";pub const macro = "macro";pub const method = "method";pub const modifier = "modifier";pub const namespace = "namespace";pub const number = "number";pub const operator = "operator";pub const parameter = "parameter";pub const property = "property";pub const regexp = "regexp";pub const string = "string";pub const @"struct" = "struct";pub const @"type" = "type";pub const typeParameter = "typeParameter";pub const variable = "variable";};
/// A set of predefined token modifiers. This set is not fixed
/// an clients can specify additional token types via the
/// corresponding client capabilities.
pub const SemanticTokenModifiers = struct {pub const abstract = "abstract";pub const @"async" = "async";pub const declaration = "declaration";pub const defaultLibrary = "defaultLibrary";pub const definition = "definition";pub const deprecated = "deprecated";pub const documentation = "documentation";pub const modification = "modification";pub const readonly = "readonly";pub const static = "static";};pub const SemanticTokensLegend = struct {
...
pub const SemanticTokensPartialResult = struct {data: []i64,
};
...
pub const SemanticTokensDelta = struct {resultId: Undefinedable([]const u8),

/// The semantic token edits to transform a previous result into a new result.
edits: []SemanticTokensEdit,
};
pub const SemanticTokensDeltaPartialResult = struct {edits: []SemanticTokensEdit,
};
pub const TokenFormat = struct {pub const Relative = "relative";};
...
full: Undefinedable(union(enum) {boolean: bool,
reflection: struct {
...
/// the server provides a corresponding handler.
range: Undefinedable(union(enum) {boolean: bool,
...
pub const SemanticTokensRequest = struct {pub const method = "textDocument/semanticTokens/full";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const SemanticTokensDeltaRequest = struct {pub const method = "textDocument/semanticTokens/full/delta";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const SemanticTokensRangeRequest = struct {pub const method = "textDocument/semanticTokens/range";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
pub const SemanticTokensRefreshRequest = struct {pub const method = ManuallyTranslateValue;pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler0;
};
pub const SemanticTokensRegistrationType = struct {pub const method = "textDocument/semanticTokens";pub const @"type" = ManuallyTranslateValue;};
...
pub const ShowDocumentRequest = struct {pub const method = "window/showDocument";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const LinkedEditingRangeOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const LinkedEditingRangeRequest = struct {pub const method = "textDocument/linkedEditingRange";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};
...
pub const DidCreateFilesNotification = struct {pub const method = "workspace/didCreateFiles";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = NotificationHandler;
};
...
pub const WillCreateFilesRequest = struct {pub const method = "workspace/willCreateFiles";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};

/// The did rename files notification is sent from the client to the server when
/// files were renamed from within the client.
pub const DidRenameFilesNotification = struct {pub const method = "workspace/didRenameFiles";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = NotificationHandler;
};
...
pub const WillRenameFilesRequest = struct {pub const method = "workspace/willRenameFiles";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};

/// The will delete files request is sent from the client to the server before files are actually
/// deleted as long as the deletion is triggered from within the client.
pub const DidDeleteFilesNotification = struct {pub const method = "workspace/didDeleteFiles";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = NotificationHandler;
};
...
pub const WillDeleteFilesRequest = struct {pub const method = "workspace/willDeleteFiles";pub const @"type" = ManuallyTranslateValue;pub const HandlerSignature = RequestHandler;
};

/// Moniker uniqueness level to define scope of the moniker.
pub const UniquenessLevel = struct {pub const document = "document";pub const global = "global";pub const group = "group";pub const project = "project";pub const scheme = "scheme";};
/// The moniker kind.
pub const MonikerKind = struct {pub const @"export" = "export";pub const @"import" = "import";pub const local = "local";};
...
pub const MonikerOptions = struct {workDoneProgress: Undefinedable(bool),
};
...
pub const MonikerRequest = struct {pub const method = "textDocument/moniker";pub const @"type" = ManuallyTranslateValue;};
